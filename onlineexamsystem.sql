...
#
# Host: den1.mysql6.gear.host (MySQL 5.7.23-log)
# Database: onlineexamsystem
# Generation Time: 2019-01-08 16:08:46 +0000
# ************************************************************
...
# Dump of table tbl_category_sub_category_list
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tbl_category_sub_category_list`;

CREATE TABLE `tbl_category_sub_category_list` (
...
LOCK TABLES `tbl_category_sub_category_list` WRITE;
/*!40000 ALTER TABLE `tbl_category_sub_category_list` DISABLE KEYS */;

INSERT INTO `tbl_category_sub_category_list` (`category_category_id`, `sub_category_list_subcategory_id`)
VALUES
	(4,11),
	(4,12),
	(5,13),
...
# Dump of table tbl_competency_analysis
# ------------------------------------------------------------
...
INSERT INTO `tbl_log` (`log_id`, `percent_obt`, `test_id`, `timestamp`, `user_id`)
VALUES
	...
	(12,10,16,'2018-12-30 13:37:30',6),
	(13,44,18,'2018-12-30 14:38:58',6);

/*!40000 ALTER TABLE `tbl_log` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tbl_options
# ------------------------------------------------------------
...
INSERT INTO `tbl_options` (`option_id`, `option_a`, `option_b`, `option_c`, `option_d`)
VALUES
	...
	(19,'JVM','JDK','JIT','JRE'),
	(20,'JVM','JDK','JIT','JRE'),
	(21,'-128 to 127','-32768 to 32767','-2147483648 to 2147483647','None of the mentioned'),
	(22,'malloc','alloc','new','new malloc'),
	(23,'JVM','JDK','JIT','JRE'),
	(24,'JVM','JDK','JIT','JRE'),
	(25,'JVM','JDK','JIT','JRE');
...
# Dump of table tbl_parent_question
# ------------------------------------------------------------
...
LOCK TABLES `tbl_parent_question` WRITE;
/*!40000 ALTER TABLE `tbl_parent_question` DISABLE KEYS */;

INSERT INTO `tbl_parent_question` (`parent_question_id`, `difficulty`, `parent_question_desc`, `subjectivity`, `test_id`, `topic_name`)
VALUES
	...
	(60,'0','Basics of Datatypes','1',18,'Java Basics'),
	(61,'1','Arrays in Java','1',18,'Java Basics'),
	(62,'1','Method Overriding ','1',18,'OOPS Concepts'),
	(63,'0','Methods in Java','0',18,'Java Basics'),
	(64,'2','Components in Java','1',18,'Java Components'),
	(65,'0','Java File ','1',18,'Java Basics');
...
INSERT INTO `tbl_question` (`question_id`, `answer`, `marks`, `parent_question_id`, `question_type`, `subtopic_name`, `question_desc`, `difficulty`, `option_id`)
VALUES
	...
	(56,'B',1,60,'3','Datatypes','What is the range of short data type in Java?',0,21),
	(57,'C',1,61,'3','Arrays','Which of these operators is used to allocate memory to array variable in Java?',1,22),
	(58,'true',1,62,'2','OOPS Concepts','Method overriding is combination of inheritance and polymorphism',1,NULL),
	(59,'null',1,63,'1','Java Basics','What is the return type of a method that does not return any value?',0,NULL),
	(60,'main',1,63,'1','Java Basics','Which method can be defined only once in a program?',1,NULL),
	(61,'B',1,64,'3','Components','Which component is used to compile, debug and execute java program?',1,23),
	(62,'A',1,64,'3','Components','Which component is responsible for converting bytecode into machine specific code?',1,24),
	(63,'D',1,64,'3','Components','Which component is responsible to run java program?',2,25),
	(64,'true',1,65,'2','Java Files','Is \'.java\' the extension of java code files?',0,NULL);

/*!40000 ALTER TABLE `tbl_question` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tbl_question_test
# ------------------------------------------------------------
...
INSERT INTO `tbl_response` (`response_id`, `question_id`, `response`, `timestamp`, `user_id`)
VALUES
	(105,45,'C',NULL,2),
	(104,44,'A',NULL,2),
	(103,55,'true',NULL,1),
	...
	(184,44,'','2018-12-30 13:36:26',6),
	(185,45,'','2018-12-30 13:36:31',6),
	(186,47,'','2018-12-30 13:36:36',6),
	(187,49,'','2018-12-30 13:36:40',6),
	(188,50,'','2018-12-30 13:36:44',6),
	(189,51,'','2018-12-30 13:36:48',6),
	(190,52,'','2018-12-30 13:36:52',6),
	(191,53,'','2018-12-30 13:36:56',6),
	(192,54,'','2018-12-30 13:37:01',6),
	(193,55,'true','2018-12-30 13:37:04',6),
	(194,56,'A','2018-12-30 14:37:59',6),
	(195,57,'C','2018-12-30 14:38:05',6),
	(196,58,'true','2018-12-30 14:38:09',6),
	(197,59,'','2018-12-30 14:38:14',6),
	(198,60,'','2018-12-30 14:38:18',6),
	(199,61,'C','2018-12-30 14:38:23',6),
	(200,62,'A','2018-12-30 14:38:27',6),
	(201,63,'C','2018-12-30 14:38:32',6),
	(202,64,'true','2018-12-30 14:38:37',6);

/*!40000 ALTER TABLE `tbl_response` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tbl_result
# ------------------------------------------------------------
...
INSERT INTO `tbl_result` (`result_id`, `marks`, `question_id`, `result`, `user_id`)
VALUES
	(1,0,44,'Incorrect',1),
	(2,0,45,'Incorrect',1),
	(3,1,47,'Correct',1),
	...
	(99,0,54,'Incorrect',6),
	(100,1,55,'Correct',6),
	(101,0,56,'Incorrect',6),
	(102,1,57,'Correct',6),
	(103,1,58,'Correct',6),
	(104,0,59,'Incorrect',6),
	(105,0,60,'Incorrect',6),
	(106,0,61,'Incorrect',6),
	(107,1,62,'Correct',6),
	(108,0,63,'Incorrect',6),
	(109,1,64,'Correct',6);
...
# Dump of table tbl_subskill_analysis
# ------------------------------------------------------------
...
INSERT INTO `tbl_test` (`test_id`, `cutoff`, `subcategory_id`, `test_name`, `total_marks`, `time`)
VALUES
	...
	(17,10,2,'Php Test',20,10),
	(18,20,11,'Dhaval',30,0);

/*!40000 ALTER TABLE `tbl_test` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tbl_test_parent_question_list
# ------------------------------------------------------------

DROP TABLE IF EXISTS `tbl_test_parent_question_list`;

CREATE TABLE `tbl_test_parent_question_list` (
...
INSERT INTO `tbl_user` (`user_id`, `dob`, `email`, `gender`, `name`, `password`, `user_type`, `username`, `country`, `is_unique`)
VALUES
	(1,'1996-10-16','neelp1543@gmail.com','male','Neel Nitinbhai Parikh','abcd','admin','neelp',NULL,b'0'),
	(5,'2018-11-01','neelp1543@gmail.com','male','Neel Parikh','11111111','admin','abcd',NULL,b'0'),
	(6,'2018-11-01','neelp1543@gmail.com','male','Neel Parikh','11111111','user','Ultraultimated',NULL,b'0'),
	(8,'1996-08-18','poojan8788@gmail.com','male','Poojan Patel','MTIzNA==','user','poojanp',NULL,b'0');

/*!40000 ALTER TABLE `tbl_user` ENABLE KEYS */;
UNLOCK TABLES;


# Dump of table tbl_user_test
# ------------------------------------------------------------
...
LOCK TABLES `tbl_user_test` WRITE;
/*!40000 ALTER TABLE `tbl_user_test` DISABLE KEYS */;

INSERT INTO `tbl_user_test` (`user_test_id`, `test_id`, `user_id`)
VALUES
	(1,13,1),
	(2,13,2),
	(3,12,1),
